                                      ...
                                      return Transform.scale(
                                        ...
                                        child: Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: (widget.userModel.profile
                                                            ?.image ==
                                                        null ||
                                                    widget.userModel.profile!
                                                        .image!.isEmpty)
                                                ? Image.asset(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildAnimatedInfoCard(
                                title: "Bio",
                                content:
                                    widget.userModel.profile?.bio?.isEmpty ??
                                            true
                                        ? "No bio available"
                                        : widget.userModel.profile?.bio ??
                                            'No bio available',
                              ...
                              GestureDetector(
                                onTap: () {
                                  launchUrl(Uri.parse(
                                      'tel:${widget.userModel.profile?.phone ?? ''}'));
                                },
                                child: _buildAnimatedInfoCard(
                                  title: "Phone Number",
                                  content: widget.userModel.profile?.phone
                                              ?.isEmpty ??
                                          true
                                      ? "No phone number available"
                                      : widget.userModel.profile!.phone!,
                                ...
                                builder: (context, child) {
                                  ...
                                  return Transform.translate(
                                    ...
                                    child: Opacity(
                                      opacity: curvedAnimation.value,
                                      child: GestureDetector(
                                        onTap: widget.userModel.profile
                                                        ?.linkedin !=
                                                    null &&
                                                widget.userModel.profile!
                                                    .linkedin!.isNotEmpty
