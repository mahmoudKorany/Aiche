...
// import 'package:skill_land/core/utils/branch_sdk_helper/brach_methodes.dart';
//
...
//
//   static FlutterBranchSdkPlatform _instance = FlutterBranchSdkMethodChannel() as FlutterBranchSdkPlatform;
//
...
//   }
//
//   ///Identifies the current auth to the Branch API by supplying a unique identifier as a userId value
...
//   }
//
//   ///Returns the last parameters associated with the link that referred the auth
//   Future<Map<dynamic, dynamic>> getLatestReferringParams() async {
//     throw UnimplementedError(
//         'getLatestReferringParams has not been implemented');
//   }
//
//   ///Returns the first parameters associated with the link that referred the auth
//   Future<Map<dynamic, dynamic>> getFirstReferringParams() async {
//     throw UnimplementedError(
//         'getFirstReferringParams has not been implemented');
//   }
//
//   ///Method to change the Tracking state. If disabled SDK will not track any auth data or state.
...
//   }
//
//   ///Indicates whether or not this auth has a custom identity specified for them. Note that this is independent of installs.
//   ///If you call setIdentity, this device will have that identity associated with this auth until logout is called.
...
//   /// [eeaRegion] `true` If European regulations, including the DMA, apply to this auth and conversion.
//   /// [adPersonalizationConsent] `true` If End auth has granted/denied ads personalization consent.
//   /// [adUserDataUsageConsent] `true If User has granted/denied consent for 3P transmission of auth level data for ads.
